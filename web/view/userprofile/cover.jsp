<%-- 
    Document   : cover
    Created on : Oct 31, 2018, 3:12:06 PM
    Author     : comp-one
--%>
...
<%
   ...
   if ((contentType.indexOf("multipart/form-data") >= 0)) {
      ...
      try { 
         ...
         filePath = "C:/Users/comp-one/Documents/NetBeansProjects/PhotoStore/web/photos/coverphotos/";
         out.println("<html>");
         out.println("<head>");
         ...
         while ( i.hasNext () ) {
            ...
            if ( !fi.isFormField () ) {
               ...
               fileName + "<br>");
              imgUrl = "photos/coverphotos/" + fileName;
              name = fileName;
              String link = request.getContextPath()+"/InsertDB?coverPhotoURL="+ imgUrl + "&artistEmail="+ email;
